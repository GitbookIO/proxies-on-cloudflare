...
// NON Globs
test.each(['/about', '/public/js/main.js', 'docs.gitbook.com'])(
  'NOT isGlob("%s")',
  (expr: string) => {
...
// Valid matches
test.each([
  ['*.gitbook.com', ['www.gitbook.com', 'docs.gitbook.com', 'app.gitbook.com']],
  ['www.google.fr', ['www.google.fr']]
])('MATCH("%s")', (expr: string, values: string[]) => {
...
// Invalid matches
test.each([
  ['*.gitbook.com', ['www.google.fr', 'www.example.com', 'google.com']],
  ['www.google.fr', ['amazon.com']]
])('NOT MATCH("%s")', (expr: string, values: string[]) => {
